            ...
            <div className=''>
                <form
                    ...
                    <div className='flex flex-col'>
                        <label className='  font-bold text-xl p-3 ml-10'>Title of your blog</label>
                        <input
                        ...
                        <label className=' font-bold text-xl p-3 ml-10'>Author Name</label>
                        <input
                            className='ml-10 rounded-md p-1'
                        ...
                        <label className=' font-bold text-xl p-3 ml-10'>Content of your blog</label>
                        <textarea
                            className='ml-10 rounded-md p-1'
                            ...
                            value={body}
                        />
                        <button className='bg-gray-400 text-black m-2 ml-10 rounded-md py-2 px-3 mt-3'>Add my Blog</button>
                        <a className='bg-gray-200 text-black m-2 ml-10 rounded-md py-2 px-3 mt-3 text-center' href='/blogs'>See all blogs</a>
                    </div>
