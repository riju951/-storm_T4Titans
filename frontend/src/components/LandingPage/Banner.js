...
const Banner = () => {
  return (
    <div>
        ...
        <div className="flex relative justify-end z-20 h-screen bg-gradient-to-r from-transparent to-black">
      <div className="p-10 text-right mr-5">
        ...
        <div className="flex cursor-pointer justify-end text-2xl space-x-4 mt-3 pt-10">
          ...
          <button className="bg-gray-600 text-white text-2xl mt-7 py-2 px-4 rounded-2xl">
            Get Started
          </button>
        </div>
      </div>
