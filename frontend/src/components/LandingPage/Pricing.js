...
<div class="bg-blue-200">
    <div class="container m-auto px-6 py-20 md:px-12 lg:px-20">
        <div class="m-auto text-center lg:w-7/12">
            <h2 class="text-2xl text-sky-900 font-bold md:text-4xl">Want more Features? Subscribe to our pro version!</h2>
        </div>
                ...
                <div class="relative p-6 space-y-6">
                    ...
                    <div class="overflow-hidden">
                        <div class="-mr-20 flex items-end justify-center">
                            <div class="flex">
                                <span class="-ml-6 mt-2 text-3xl text-cyan-500 font-bold">₹</span>
                                <span class="text-8xl text-gray-800 font-bold leading-0">500</span>
                            </div>
                            <div class="mb-2">
